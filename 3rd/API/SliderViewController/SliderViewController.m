...
- (void)viewDidLoad
{
    ...
    [self showContentController:_MainVC];
...
- (void)closeSideBar
{
    [[NSNotificationCenter defaultCenter]postNotificationName:@"ButtonLeft" object:nil];
...
- (void)showLeft:(BOOL)bShow
{
    if (bShow)
    {
        [[NSNotificationCenter defaultCenter]postNotificationName:@"Buttoright" object:nil];
        [UIView beginAnimations:nil context:nil];
