...
- (void)setStatus:(NSString *)string {
    ...
    if(string) {
        ...
        CGSize stringSize = [string boundingRectWithSize:CGSizeMake(200, 300) options:NSStringDrawingUsesLineFragmentOrigin attributes:attribute context:nil].size;
...
- (UIView *)hudView {
    if(!hudView) {
		...
		hudView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.7];
...
//        [self.hudView bringSubviewToFront:imageView];
//    }
    return imageView;
}
