...
- (void)addCenterLabel{
    ...
    if (_percent == 1) {
        ...
        percent = [NSString stringWithFormat:@"%.0f%s",_percent*100,"\%"];
    ...
    NSDictionary *attributes = [NSDictionary dictionaryWithObjectsAndKeys:[UIFont boldSystemFontOfSize:fontSize],NSFontAttributeName ,RGBA(84, 84, 84, 84),NSForegroundColorAttributeName,[UIColor clearColor],NSBackgroundColorAttributeName,paragraph,NSParagraphStyleAttributeName,nil];
